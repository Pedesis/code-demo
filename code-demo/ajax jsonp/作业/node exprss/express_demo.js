...
var fs = require("fs")
//读取dataFile
var loadTotosFromFile = function (callback) {
...
app.post('/todo/add', function (resquest, response) {
    // request.body
    var todo = resquest.body;
    //console.log("sf",resquest.body,typeof resquest.body)
...
ajax("POST","/todo/add",'{"task":"吃饭"}',function(r){
console.log(r);
})
*/
